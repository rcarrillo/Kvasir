...
db.define_table('t_vulndata',
    ...
    Field('f_cvss_i_score', type='float', label=T('CVSS Temporal Score'), requires=IS_EMPTY_OR(IS_FLOAT_IN_RANGE(0, 10))),
    Field('f_cvss_e_score', type='float', label=T('CVSS Enviromental Score'), requires=IS_EMPTY_OR(IS_FLOAT_IN_RANGE(0, 10))),
...
def ref_id_represent(f_source, f_text):
    ...
    ulinks = { 'CVE': lambda x: A(x, _target="_blank", _rel="noreferrer,external", _href="https://cve.mitre.org/cgi-bin/cvename.cgi?name=%s" % (x)),
               'URL': lambda x: A(x, _target="_blank", _rel="noreferrer,external", _href=x),
               'BID': lambda x: A("BugTraq %s"%x, _target="_blank", _rel="noreferrer,external", _href="http://www.securityfocus.com/bid/%s" %(x)),
               'XF':  lambda x: A("ISS XForce %s"%x, _target="_blank", _rel="noreferrer,external", _href="http://xforce.iss.net/xforce/xfdb/%s" % (x)),
               'ISS':  lambda x: A("ISS XForce %s"%x, _target="_blank", _rel="noreferrer,external", _href="http://xforce.iss.net/xforce/xfdb/%s" % (x)),
               'MSKB': lambda x: A("MSKB %s"%x, _target="_blank", _rel="noreferrer,external", _href="http://support.microsoft.com/kb/%s" %(x)),
               'OSVDB': lambda x: A("OSVDB %s"%x, _target="_blank", _rel="noreferrer,external", _href="http://osvdb.org/show/osvdb/%s" % (x)),
               'SECUNIA': lambda x: A("Secunia %s"%x, _target="_blank", _rel="noreferrer,external", _href="https://secunia.com/advisories/%s" % (x)),
               'MANDRAKE': lambda x: A("Mandrake %s"%x, _target="_blank", _rel="noreferrer,external", _href='http://lwn.net/Alerts/Mandrake/'),
               'MANDRIVA': lambda x: A("Mandriva %s"%x, _target="_blank", _rel="noreferrer,external", _href='http://www.mandriva.com/security/advisories'),
               'REDHAT': lambda x: A("RedHat %s"%x,_target="_blank", _rel="noreferrer,external",  _href='http://www.redhat.com/support/errata/index.html'),
               'CERT': lambda x: A("CERT VU#%s"%x, _target="_blank", _rel="noreferrer,external", _href='www.kb.cert.org/vuls/id/%s' % (x)),
               'CERT-VN': lambda x: A("CERT VU#%s"%x, _target="_blank", _rel="noreferrer,external", _href='www.kb.cert.org/vuls/id/%s' % (x)),
               'SECTRACK': lambda x: A("Security Tracker %s"%x, _target="_blank", _rel="noreferrer,external", _href='http://www.securitytracker.com/'),
               'OVAL': lambda x: A("OVAL %s"%x, _target="_blank", _rel="noreferrer,external", _href='https://oval.mitre.org/repository/data/SearchDefinitionAdv?id=%s&advsearch=Search' % (x.replace('OVAL', ''))),
               'MS': lambda x: A("Microsoft %s"%x, _target="_blank", _rel="noreferrer,external", _href='http://www.microsoft.com/technet/security/current.aspx'),
               'GENTOO': lambda x: A("Gentoo %s"%x, _target="_blank", _rel="noreferrer,external", _href='http://www.gentoo.org/security/en/glsa/'),
               'SANS-06': lambda x: A("SANS %s"%x, _target="_blank", _rel="noreferrer,external", _href='http://isc.sans.org'),
               'SANS-07': lambda x: A("SANS %s"%x, _target="_blank", _rel="noreferrer,external", _href='http://isc.sans.org'),
               'SANS-08': lambda x: A("SANS %s"%x, _target="_blank", _rel="noreferrer,external", _href='http://isc.sans.org'),
               'SANS-09': lambda x: A("SANS %s"%x, _target="_blank", _rel="noreferrer,external", _href='http://isc.sans.org'),
               'SANS-10': lambda x: A("SANS %s"%x, _target="_blank", _rel="noreferrer,external", _href='http://isc.sans.org'),
               'SANS-11': lambda x: A("SANS %s"%x, _target="_blank", _rel="noreferrer,external", _href='http://isc.sans.org'),
               'AIXAPAR': lambda x: A("SANS %s"%x, _target="_blank", _rel="noreferrer,external", _href='http://www-01.ibm.com/support/search.wss?rs=0&apar=only'),
               'APPLE': lambda x: A("Apple %s"%x, _target="_blank", _rel="noreferrer,external", _href='http://lists.apple.com/archives/security-announce'),
               'CISCO': lambda x: A("Cisco %s"%x, _target="_blank", _rel="noreferrer,external", _href='http://www.cisco.com/en/US/products/products_security_advisories_listing.html'),
               'AUSCERT': lambda x: A("AUSCert %s"%x, _target="_blank", _rel="noreferrer,external", _href='http://www.auscert.org.au/Information/advisories.html'),
               'BEA': lambda x: A("BEA %s"%x, _target="_blank", _rel="noreferrer,external", _href='http://dev2dev.bea.com/advisoriesnotifications/index.csp'),
               'CALDERA': lambda x: A("Caldera %s"%x, _target="_blank", _rel="noreferrer,external", _href='http://www.calderasystems.com/support/security/'),
               'CHECKPOINT': lambda x: A("Checkpoint %s"%x, _target="_blank", _rel="noreferrer,external", _href='http://www.checkpoint.com/defense/advisories/public/summary.html'),
               'CIAC': lambda x: A("CIAC %s"%x, _target="_blank", _rel="noreferrer,external", _href='http://ciac.llnl.gov/cgi-bin/index/bulletins'),
               'COMPAQ': lambda x: A("COMPAQ %s"%x, _target="_blank", _rel="noreferrer,external", _href='http://ftp.support.compaq.com/patches/.new/security.html'),
               'CONECTIVA': lambda x: A("Conectiva %s"%x, _target="_blank", _rel="noreferrer,external", _href='http://lwn.net/Alerts/Conectiva/'),
               'DEBIAN': lambda x: A("Debian %s"%x, _target="_blank", _rel="noreferrer,external", _href='http://www.debian.org/security/'),
               'EEYE': lambda x: A("eEye %s"%x, _target="_blank", _rel="noreferrer,external", _href='http://research.eeye.com/html/advisories/index.html'),
               'ENGARDE': lambda x: A("Engarde %s"%x, _target="_blank", _rel="noreferrer,external", _href='http://lwn.net/Alerts/EnGarde/'),
               'EXPLOIT-DB': lambda x: A("Exploit-db %s"%x, _target="_blank", _rel="noreferrer,external", _href='http://www.exploit-db.com/exploits/%s' % (x)),
               'FEDORA': lambda x: A("Fedora %s"%x, _target="_blank", _rel="noreferrer,external", _href='http://www.redhat.com/archives/fedora-announce-list/'),
               'FREEBSD': lambda x: A("FreeBSD %s"%x, _target="_blank", _rel="noreferrer,external", _href='http://www.freebsd.org/security/'),
               'FRSIRT': lambda x: A("Vupen %s"%x, _target="_blank", _rel="noreferrer,external", _href='http://www.vupen.com/english/'),
               'FULLDISC': lambda x: A("Full-Disclosure %s"%x, _target="_blank", _rel="noreferrer,external", _href='http://lists.grok.org.uk/pipermail/full-disclosure/'),
               'FarmerVenema': lambda x: A("Farmer/Venema %s"%x, _target="_blank", _rel="noreferrer,external", _href='http://www.alw.nih.gov/Security/Docs/admin-guide-to-cracking.101.html'),
               'HP': lambda x: A("HP %s"%x, _target="_blank", _rel="noreferrer,external", _href='http://www.itrc.hp.com/service/cki/secBullArchive.do'),
               'IDEFENSE': lambda x: A("iDefense %s"%x, _target="_blank", _rel="noreferrer,external", _href='http://labs.idefense.com/intelligence/vulnerabilities/'),
               'NETBSD': lambda x: A("NetBSD %s"%x, _target="_blank", _rel="noreferrer,external", _href='http://www.netbsd.org/Security/advisory.html'),
               'OPENBSD': lambda x: A("OpenBSD %s"%x, _target="_blank", _rel="noreferrer,external", _href='http://www.openbsd.org/security.html'),
               'SUN': lambda x: A("SUN %s"%x, _target="_blank", _rel="noreferrer,external", _href='http://search.sun.com/main/index.jsp?col=main-support-sunalerts&oneof=security&nh=100&rf=1&type=advanced&optstat=true'),
               'SUNALERT': lambda x: A("SUN Alert %s"%x, _target="_blank", _rel="noreferrer,external", _href='http://search.sun.com/main/index.jsp?col=main-support-sunalerts&oneof=security&nh=100&rf=1&type=advanced&optstat=true'),
               'SUSE': lambda x: A("SuSE %s"%x, _target="_blank", _rel="noreferrer,external", _href='http://www.novell.com/linux/security/advisories.html'),
               'UBUNTU': lambda x: A("Ubuntu %s"%x, _target="_blank", _rel="noreferrer,external", _href='http://www.ubuntu.com/usn/'),
...
db.define_table('t_vuln_refs',
    ...
    Field('f_source', type='string', label=T('Source'), requires=IS_NOT_EMPTY()),
    Field('f_text', type='string', label=T('Text'), requires=IS_NOT_EMPTY(), represent=lambda id,row: ref_id_represent(row.f_source, row.f_text)),
    auth.signature,
...
db.define_table('t_vuln_references',
    ...
    Field('f_vuln_ref_id', 'reference t_vuln_refs', label=T('Reference'), represent=lambda id,row: ref_id_represent(db.t_vuln_refs[id].f_source, db.t_vuln_refs[id].f_text)),
    auth.signature,
